...
|Endpoint                       |Unsigned 8-bit integer     |
|Application Profile ID         |Unsigned 16-bit integer    |
|Application Device ID          |Unsigned 16-bit integer    |
|Application Device Version     |Unsigned 8-bit integer     |
|Application Input Clusters     |N X NWK Address            |
|Application Output Clusters    |N X NWK Address            |
