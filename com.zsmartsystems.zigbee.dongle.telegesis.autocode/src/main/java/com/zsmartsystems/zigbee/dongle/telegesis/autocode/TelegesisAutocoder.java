...
import com.zsmartsystems.zigbee.dongle.telegesis.autocode.xml.Structure;
...
public class TelegesisAutocoder {
    public static void main(final String[] args)  {
        ...
        try {
            ...
            File fXmlFile = new File("src/main/resources/telegesis_at_protocol.xml");
        ...
        switch (node.getNodeName()) {
            ...
            case "response_parameters":
                ...
                for (int temp = 0; temp < nodes.getLength(); temp++) {
                    ...
                    if (nodes.item(temp).getNodeName().equals("prompt")) {
            ...
            case "parameter":
                ...
                for (int temp = 0; temp < nodes.getLength(); temp++) {
                    ...
                    if (nodes.item(temp).getNodeName().equals("terminator")) {
                        parameter.terminator = nodes.item(temp).getTextContent();
                    }
