 ...
 * <p>
 * <p>
 * The IEEE_addr_rsp is generated by a Remote Device in response to an IEEE_addr_req command
 * inquiring as to the 64-bit IEEE address of the Remote Device or the 64-bit IEEE address of an
 * address held in a local discovery cache. The destination addressing on this command shall be
 * unicast.
 * <p>
...
public class IeeeAddressResponse extends ZdoResponse {
     ...
     * The ZDO cluster ID.
     */
    public static int CLUSTER_ID = 0x8001;
