 ...
 * <p>
 * <p>
 * The User_Desc_req command is generated from a local device wishing to inquire as to the user
...
public class UserDescriptorRequest extends ZdoRequest implements ZigBeeTransactionMatcher {
     ...
     * The ZDO cluster ID.
     */
    public static int CLUSTER_ID = 0x0011;
    ...
    public boolean isTransactionMatch(ZigBeeCommand request, ZigBeeCommand response) {
        return (response instanceof UserDescriptorResponse)
                && ((ZdoRequest) request).getDestinationAddress().equals(((UserDescriptorResponse) response).getSourceAddress());
    }
