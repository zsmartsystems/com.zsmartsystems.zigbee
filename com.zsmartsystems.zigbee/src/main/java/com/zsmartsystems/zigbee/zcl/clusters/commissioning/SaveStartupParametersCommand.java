...
public class SaveStartupParametersCommand extends ZclCommand {
     ...
     * @return the SaveStartupParametersCommand command
     */
    public SaveStartupParametersCommand setOption(final Integer option) {
        this.option = option;
        return this;
    }
     ...
     * @return the SaveStartupParametersCommand command
     */
    public SaveStartupParametersCommand setIndex(final Integer index) {
        this.index = index;
        return this;
    }
