...
public class PublishConversionFactorCommand extends ZclCommand {
     ...
     * @return the PublishConversionFactorCommand command
     */
    public PublishConversionFactorCommand setIssuerEventId(final Integer issuerEventId) {
     ...
     * @return the PublishConversionFactorCommand command
     */
    public PublishConversionFactorCommand setStartTime(final Calendar startTime) {
     ...
     * @return the PublishConversionFactorCommand command
     */
    public PublishConversionFactorCommand setConversionFactor(final Integer conversionFactor) {
     ...
     * @return the PublishConversionFactorCommand command
     */
    public PublishConversionFactorCommand setConversionFactorTrailingDigit(final Integer conversionFactorTrailingDigit) {
