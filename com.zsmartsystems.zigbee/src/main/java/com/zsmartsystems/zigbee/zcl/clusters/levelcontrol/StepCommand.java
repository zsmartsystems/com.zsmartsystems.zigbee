...
public class StepCommand extends ZclCommand {
     ...
     * @return the StepCommand command
     */
    public StepCommand setStepMode(final Integer stepMode) {
     ...
     * @return the StepCommand command
     */
    public StepCommand setStepSize(final Integer stepSize) {
     ...
     * @return the StepCommand command
     */
    public StepCommand setTransitionTime(final Integer transitionTime) {
