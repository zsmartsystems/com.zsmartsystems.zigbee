...
/**
 * Get Week Day Schedule Response value object class.
 * <p>
 * Cluster: <b>Door Lock</b>. Command ID 0x0C is sent <b>FROM</b> the server.
...
public class GetWeekDayScheduleResponse extends ZclDoorLockCommand {
    /**
    ...
    public void serialize(final ZclFieldSerializer serializer) {
        ...
        serializer.serialize(daysMask, ZclDataType.UNSIGNED_8_BIT_INTEGER);
    ...
    public void deserialize(final ZclFieldDeserializer deserializer) {
        ...
        daysMask = deserializer.deserialize(ZclDataType.UNSIGNED_8_BIT_INTEGER);
    ...
    public String toString() {
        ...
        builder.append("GetWeekDayScheduleResponse [");
