...
public class StepSaturationCommand extends ZclCommand {
     ...
     * @return the StepSaturationCommand command
     */
    public StepSaturationCommand setStepMode(final Integer stepMode) {
     ...
     * @return the StepSaturationCommand command
     */
    public StepSaturationCommand setStepSize(final Integer stepSize) {
     ...
     * @return the StepSaturationCommand command
     */
    public StepSaturationCommand setTransitionTime(final Integer transitionTime) {
