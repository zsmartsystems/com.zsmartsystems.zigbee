...
public class DiscoverCommandsReceivedResponse extends ZclCommand {
     ...
     * @return the DiscoverCommandsReceivedResponse command
     */
    public DiscoverCommandsReceivedResponse setDiscoveryComplete(final Boolean discoveryComplete) {
     ...
     * @return the DiscoverCommandsReceivedResponse command
     */
    public DiscoverCommandsReceivedResponse setCommandIdentifiers(final List<Integer> commandIdentifiers) {
