...
public enum AnalogInputReliabilityEnum {
     ...
     */
    private static Map<Integer, AnalogInputReliabilityEnum> idMap;

    static {
        idMap = new HashMap<Integer, AnalogInputReliabilityEnum>();
        for (AnalogInputReliabilityEnum enumValue : values()) {
    ...
    private AnalogInputReliabilityEnum(final int key) {
        this.key = key;
    }
    ...
    public static AnalogInputReliabilityEnum getByValue(final int value) {
