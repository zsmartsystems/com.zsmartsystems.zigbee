...
public enum ZclDataType {
    ...
    BITMAP_24_BIT("16-bit Bitmap", Integer.class, 0x1A, false),
    BITMAP_32_BIT("32-bit Bitmap", Integer.class, 0x1B, false),
    BITMAP_40_BIT("40-bit Bitmap", Integer.class, 0x1C, false),
    BITMAP_48_BIT("48-bit Bitmap", Integer.class, 0x1D, false),
    BITMAP_56_BIT("56-bit Bitmap", Integer.class, 0x1E, false),
    BITMAP_64_BIT("64-bit Bitmap", Integer.class, 0x1F, false),
    ...
    RAW_OCTET("Raw Octet Array", ByteArray.class, 0x00, false),
