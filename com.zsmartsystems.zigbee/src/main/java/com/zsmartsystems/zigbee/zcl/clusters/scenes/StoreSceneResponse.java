...
public class StoreSceneResponse extends ZclCommand {
     ...
     * @return the StoreSceneResponse command
     */
    public StoreSceneResponse setStatus(final Integer status) {
        this.status = status;
        return this;
    }
     ...
     * @return the StoreSceneResponse command
     */
    public StoreSceneResponse setGroupId(final Integer groupId) {
     ...
     * @return the StoreSceneResponse command
     */
    public StoreSceneResponse setSceneId(final Integer sceneId) {
