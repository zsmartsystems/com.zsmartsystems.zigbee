 ...
 * <p>
 * Cluster: <b>Price</b>. Command ID 0x0C is sent <b>TO</b> the server.
 * This command is a <b>specific</b> command used for the Price cluster.
 * <p>
 * This command initiates one or more PublishConsolidatedBill commands with the requested
 * billing information.
 * <p>
...
public class GetConsolidatedBillCommand extends ZclPriceCommand {
     ...
     * <p>
     * UTCTime stamp indicating the earliest start time of billing information to be returned
     * by the corresponding PublishConsolidatedBill command. The first returned
     * PublishConsolidatedBill command shall be the instance which is active or becomes
     ...
     * <p>
     * A 32-bit integer representing the minimum Issuer Event ID of billing information to be
     * returned by the corresponding PublishConsolidatedBill command. A value of
     * 0xFFFFFFFF means not specified; the server shall return information irrespective of
     ...
     * TariffType is not specified, the server shall return all billing information
