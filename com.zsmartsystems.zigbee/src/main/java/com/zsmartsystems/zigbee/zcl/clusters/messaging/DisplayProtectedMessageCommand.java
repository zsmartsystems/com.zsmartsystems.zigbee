 ...
 * <p>
 * Cluster: <b>Messaging</b>. Command ID 0x02 is sent <b>TO</b> the server.
...
public class DisplayProtectedMessageCommand extends ZclMessagingCommand {
     ...
     * message. A UTC Time field to indicate the date/time at which all existing display
    ...
    public void deserialize(final ZclFieldDeserializer deserializer) {
        ...
        startTime = (ZigBeeUtcTime) deserializer.deserialize(ZclDataType.UTCTIME);
