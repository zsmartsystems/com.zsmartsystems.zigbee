 ...
 * <p>
 * Cluster: <b>Scenes</b>. Command ID 0x40 is sent <b>TO</b> the server.
 * This command is a <b>specific</b> command used for the Scenes cluster.
 * <p>
 * The Enhanced Add Scene command allows a scene to be added using a finer scene transition time
 * than the Add Scene command.
 * <p>
