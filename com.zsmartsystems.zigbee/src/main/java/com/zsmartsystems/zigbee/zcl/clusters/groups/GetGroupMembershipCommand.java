...
public class GetGroupMembershipCommand extends ZclCommand {
     ...
     * @return the GetGroupMembershipCommand command
     */
    public GetGroupMembershipCommand setGroupCount(final Integer groupCount) {
     ...
     * @return the GetGroupMembershipCommand command
     */
    public GetGroupMembershipCommand setGroupList(final List<Integer> groupList) {
