 ...
 * <p>
 * Cluster: <b>Scenes</b>. Command ID 0x04 is sent <b>TO</b> the server.
...
public class StoreSceneCommand extends ZclCommand {
     ...
     * @return the StoreSceneCommand command
     */
    public StoreSceneCommand setGroupId(final Integer groupId) {
     ...
     * @return the StoreSceneCommand command
     */
    public StoreSceneCommand setSceneId(final Integer sceneId) {
