...
public class MoveToSaturationCommand extends ZclCommand {
     ...
     * @return the MoveToSaturationCommand command
     */
    public MoveToSaturationCommand setSaturation(final Integer saturation) {
     ...
     * @return the MoveToSaturationCommand command
     */
    public MoveToSaturationCommand setTransitionTime(final Integer transitionTime) {
