...
public class ZclPriceCluster extends ZclCluster {
    ...
    protected Map<Integer, ZclAttribute> initializeAttributes() {
        ...
        attributeMap.put(ATTR_CREDITCARDPAYMENTREF5, new ZclAttribute(this, ATTR_CREDITCARDPAYMENTREF5, "Credit Card Payment Ref 5", ZclDataType.OCTET_STRING, false, true, true, false));
