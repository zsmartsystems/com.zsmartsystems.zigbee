 ...
 * <p>
 * Cluster: <b>Commissioning</b>. Command ID 0x03 is sent <b>FROM</b> the server.
...
public class ResetStartupParametersResponse extends ZclCommand {
     ...
     * @return the ResetStartupParametersResponse command
     */
    public ResetStartupParametersResponse setStatus(final Integer status) {
        this.status = status;
        return this;
    }
