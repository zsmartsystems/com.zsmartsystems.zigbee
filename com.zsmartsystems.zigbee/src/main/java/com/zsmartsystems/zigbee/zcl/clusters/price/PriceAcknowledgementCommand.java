...
public class PriceAcknowledgementCommand extends ZclCommand {
     ...
     * @return the PriceAcknowledgementCommand command
     */
    public PriceAcknowledgementCommand setProviderId(final Integer providerId) {
     ...
     * @return the PriceAcknowledgementCommand command
     */
    public PriceAcknowledgementCommand setIssuerEventId(final Integer issuerEventId) {
     ...
     * @return the PriceAcknowledgementCommand command
     */
    public PriceAcknowledgementCommand setPriceAckTime(final Calendar priceAckTime) {
     ...
     * @return the PriceAcknowledgementCommand command
     */
    public PriceAcknowledgementCommand setControl(final Integer control) {
