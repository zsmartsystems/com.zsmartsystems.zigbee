 ...
 * <p>
 * Cluster: <b>Groups</b>. Command ID 0x01 is sent <b>TO</b> the server.
...
public class ViewGroupCommand extends ZclCommand {
     ...
     * @return the ViewGroupCommand command
     */
    public ViewGroupCommand setGroupId(final Integer groupId) {
