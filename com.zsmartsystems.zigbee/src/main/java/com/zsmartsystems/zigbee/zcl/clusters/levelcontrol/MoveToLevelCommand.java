...
public class MoveToLevelCommand extends ZclCommand {
     ...
     * @return the MoveToLevelCommand command
     */
    public MoveToLevelCommand setLevel(final Integer level) {
        this.level = level;
        return this;
    }
     ...
     * @return the MoveToLevelCommand command
     */
    public MoveToLevelCommand setTransitionTime(final Integer transitionTime) {
