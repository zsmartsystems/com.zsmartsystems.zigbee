...
/**
 * Ack Transfer Data Server To Client value object class.
 * <p>
 * Cluster: <b>Smart Energy Tunneling</b>. Command ID 0x03 is sent <b>FROM</b> the server.
...
public class AckTransferDataServerToClient extends ZclCommand {
     ...
     * Default constructor.
     */
    public AckTransferDataServerToClient() {
     ...
     * @return the AckTransferDataServerToClient command
     */
    public AckTransferDataServerToClient setTunnelId(final Integer tunnelId) {
     ...
     * @return the AckTransferDataServerToClient command
     */
    public AckTransferDataServerToClient setNumberOfBytesLeft(final Integer numberOfBytesLeft) {
    ...
    public String toString() {
        ...
        builder.append("AckTransferDataServerToClient [");
