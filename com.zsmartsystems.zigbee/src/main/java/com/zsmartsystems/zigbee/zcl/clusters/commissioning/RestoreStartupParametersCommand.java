...
public class RestoreStartupParametersCommand extends ZclCommand {
     ...
     * @return the RestoreStartupParametersCommand command
     */
    public RestoreStartupParametersCommand setOption(final Integer option) {
        this.option = option;
        return this;
    }
     ...
     * @return the RestoreStartupParametersCommand command
     */
    public RestoreStartupParametersCommand setIndex(final Integer index) {
        this.index = index;
        return this;
    }
