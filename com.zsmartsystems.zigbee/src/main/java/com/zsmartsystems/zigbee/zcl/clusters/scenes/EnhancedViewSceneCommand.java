 ...
 * <p>
 * Cluster: <b>Scenes</b>. Command ID 0x41 is sent <b>TO</b> the server.
 * This command is a <b>specific</b> command used for the Scenes cluster.
 * <p>
 * The Enhanced View Scene command allows a scene to be retrieved using a finer scene transition
 * time than the View Scene command.
 * <p>
