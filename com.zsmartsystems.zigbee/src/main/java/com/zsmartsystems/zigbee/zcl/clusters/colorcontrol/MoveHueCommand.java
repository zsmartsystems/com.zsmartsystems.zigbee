 ...
 * <p>
 * Cluster: <b>Color Control</b>. Command ID 0x01 is sent <b>TO</b> the server.
...
public class MoveHueCommand extends ZclCommand {
     ...
     * @return the MoveHueCommand command
     */
    public MoveHueCommand setMoveMode(final Integer moveMode) {
     ...
     * @return the MoveHueCommand command
     */
    public MoveHueCommand setRate(final Integer rate) {
        this.rate = rate;
        return this;
    }
