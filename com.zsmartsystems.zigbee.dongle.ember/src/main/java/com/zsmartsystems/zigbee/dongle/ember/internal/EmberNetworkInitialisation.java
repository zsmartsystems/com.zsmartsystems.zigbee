...
public class EmberNetworkInitialisation {
     ...
     */
    public EmberNetworkInitialisation(ZigBeeDongleEzsp zigBeeDongleEzsp) {
        this.zigBeeDongleEzsp = zigBeeDongleEzsp;
        this.protocolHandler = zigBeeDongleEzsp.getProtocolHandler();
    }
     ...
     */
    public ZigBeeStatus formNetwork(EmberNcp ncp, EmberNetworkParameters networkParameters, ZigBeeKey linkKey, ZigBeeKey networkKey) {
