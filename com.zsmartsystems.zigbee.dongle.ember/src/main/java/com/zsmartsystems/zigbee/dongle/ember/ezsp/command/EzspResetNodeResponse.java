 ...
 */
public class EzspResetNodeResponse extends EzspFrameResponse {
    public static final int FRAME_ID = 0x104;

    /**
     * Response and Handler constructor
     */
    public EzspResetNodeResponse(int ezspVersion, int[] inputBuffer) {
    ...
    public String toString() {
        ...
        builder.append("EzspResetNodeResponse [networkId=");
