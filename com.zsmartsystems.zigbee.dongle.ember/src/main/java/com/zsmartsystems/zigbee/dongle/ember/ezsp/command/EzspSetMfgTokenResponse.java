 ...
 */
public class EzspSetMfgTokenResponse extends EzspFrameResponse {
     ...
     */
    public EzspSetMfgTokenResponse(int ezspVersion, int[] inputBuffer) {
    ...
    public String toString() {
        ...
        builder.append("EzspSetMfgTokenResponse [networkId=");
