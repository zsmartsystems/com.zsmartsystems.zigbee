 ...
 */
public class EzspStackStatusHandlerRequest extends EzspFrameRequest {
    private static final Logger logger = LoggerFactory.getLogger(EzspStackStatusHandlerRequest.class);
     ...
     * Request constructor
     */
    public EzspStackStatusHandlerRequest() {
