 ...
 */
public class EzspSecManImportLinkKeyResponse extends EzspFrameResponse {
     ...
     */
    public EzspSecManImportLinkKeyResponse(int[] inputBuffer) {
    ...
    public String toString() {
        ...
        builder.append("EzspSecManImportLinkKeyResponse [networkId=");
