...
/**
 * Class to implement the Ember Enumeration <b>EmberConfigTxPowerMode</b>.
 * <p>
 */
public enum EmberConfigTxPowerMode {
    ...
    /**
     * Enable the alternate transmitter output. This allows for
     ...
     */
    private static Map<Integer, EmberConfigTxPowerMode> codeMapping;

    private int key;

    private EmberConfigTxPowerMode(int key) {
        this.key = key;
    }

    private static void initMapping() {
        codeMapping = new HashMap<Integer, EmberConfigTxPowerMode>();
        for (EmberConfigTxPowerMode s : values()) {
     ...
     */
    public static EmberConfigTxPowerMode getEmberConfigTxPowerMode(int code) {
        if (codeMapping == null) {
            initMapping();
        }
