...
public enum EzspDecisionId {
    ...
    /**
     * Send the network key in the clear to all joining devices. Rejoining devices are sent the network
     * key encrypted with their trust center link key. The trust center and any rejoining device are
     * assumed to share a link key, either preconfigured or obtained under a previous policy.
     */
