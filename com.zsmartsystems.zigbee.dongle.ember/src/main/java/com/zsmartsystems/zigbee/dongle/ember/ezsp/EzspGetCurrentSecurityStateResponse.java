...
public class EzspGetCurrentSecurityStateResponse extends EzspFrameResponse {
    private static final Logger logger = LoggerFactory.getLogger(EzspGetCurrentSecurityStateResponse.class);
    ...
    public String toString() {
        ...
        builder.append("EzspGetCurrentSecurityStateResponse [success=");
