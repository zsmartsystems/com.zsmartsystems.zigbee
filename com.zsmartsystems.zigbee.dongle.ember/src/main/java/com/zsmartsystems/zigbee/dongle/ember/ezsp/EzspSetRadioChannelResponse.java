 ...
 * channels, see the technical specification for the RF communication module in your Developer
 * Kit. Note: Care should be taken when using this API, as all devices on a network must use the same
 * channel.
 * <p>
...
public class EzspSetRadioChannelResponse extends EzspFrameResponse {
    private static final Logger logger = LoggerFactory.getLogger(EzspSetRadioChannelResponse.class);
