 ...
 */
public class EzspStopScanResponse extends EzspFrameResponse {
    private static final Logger logger = LoggerFactory.getLogger(EzspStopScanResponse.class);
     ...
     */
    public EzspStopScanResponse(int[] inputBuffer) {
        super(inputBuffer);
    }
