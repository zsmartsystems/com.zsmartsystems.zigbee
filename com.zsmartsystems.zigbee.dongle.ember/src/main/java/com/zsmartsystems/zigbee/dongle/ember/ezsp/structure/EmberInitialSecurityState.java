 ...
 * <p>
 * The security data used to set the configuration for the stack, or the retrieved configuration
 * currently in use.
 * <p>
...
public class EmberInitialSecurityState {
     ...
     * be when the device forms or joins the network.
     * <p>
     ...
     * security bitmask must be set with the EMBER_HAVE_PRECONFIGURED_KEY bit to indicate that the
    ...
    /**
     * The Network Key that should be used by the Trust Center when it forms the network, or the Network
     * Key currently in use by a joined device. The security bitmask must be set with
     ...
     * set prior to joining the network and instead it is learned during the joining message exchange.
