 ...
 */
public class EzspClearTemporaryDataMaybeStoreLinkKeyResponse extends EzspFrameResponse {
     ...
     */
    public EzspClearTemporaryDataMaybeStoreLinkKeyResponse(int ezspVersion, int[] inputBuffer) {
