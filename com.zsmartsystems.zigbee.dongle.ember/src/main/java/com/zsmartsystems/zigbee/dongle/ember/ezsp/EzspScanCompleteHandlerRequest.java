 ...
 */
public class EzspScanCompleteHandlerRequest extends EzspFrameRequest {
    private static final Logger logger = LoggerFactory.getLogger(EzspScanCompleteHandlerRequest.class);
     ...
     * Request constructor
     */
    public EzspScanCompleteHandlerRequest() {
