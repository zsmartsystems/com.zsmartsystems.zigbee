 ...
 */
public class EzspRemoteSetBindingHandlerRequest extends EzspFrameRequest {
    private static final Logger logger = LoggerFactory.getLogger(EzspRemoteSetBindingHandlerRequest.class);
     ...
     * Request constructor
     */
    public EzspRemoteSetBindingHandlerRequest() {
