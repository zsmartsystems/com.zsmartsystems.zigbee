...
public class EzspSetConcentratorRequestTest extends EzspFrameTest {
    ...
    public void testEnabled() throws Exception {
        ...
        assertTrue(Arrays.equals(getPacketData("34 00 10 01 F9 FF 3C 00 10 0E 08 08 00"), request.serialize(4)));
    }
    ...
    public void testDisabled() throws Exception {
        ...
        assertTrue(Arrays.equals(getPacketData("34 00 10 00 F8 FF 3C 00 10 0E 08 08 00"), request.serialize(4)));
    }
}
