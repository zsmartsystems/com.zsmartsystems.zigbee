...
public class XBeeCreateSourceRouteCommandTest {
    ...
    public void test() {
        ...
        assertTrue(Arrays.equals(new int[] { 0x7E, 0x00, 0x14, 0x21, 0x00, 0x00, 0x13, 0xA2, 0x00, 0x40, 0x40, 0x11,
                0x22, 0x33, 0x44, 0x00, 0x03, 0xEE, 0xFF, 0xCC, 0xDD, 0xAA, 0xBB, 0x01 }, command.serialize()));
    }
}
