 ...
 *
 */
public class XBeeMultiResponseTransaction implements XBeeTransaction {
    /**
     * The request we sent
     */
     ...
     */
    private List<XBeeEvent> responses = new ArrayList<XBeeEvent>();
    ...
    public XBeeMultiResponseTransaction(XBeeCommand request, Class<?> requiredResponse,
    ...
    @Override
    public synchronized boolean isMatch(XBeeEvent response) {
    ...
    @Override
    public synchronized XBeeEvent getResponse() {
        if (!responses.isEmpty()) {
    ...
    @Override
    public synchronized List<XBeeEvent> getResponses() {
        if (responses.isEmpty()) {
            return null;
        }
