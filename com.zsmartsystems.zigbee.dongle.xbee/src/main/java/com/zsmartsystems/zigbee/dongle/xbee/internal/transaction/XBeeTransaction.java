...
/**
 * Interface for XBee protocol transaction.
 * <p>
 ...
 *
 */
public interface XBeeTransaction {
    /**
     ...
     */
    boolean isMatch(XBeeEvent response);
