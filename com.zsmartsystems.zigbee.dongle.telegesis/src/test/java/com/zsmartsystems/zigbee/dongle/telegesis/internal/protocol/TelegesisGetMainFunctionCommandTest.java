 ...
 *
 */
public class TelegesisGetMainFunctionCommandTest extends TelegesisFrameBaseTest {
    @Test
    public void test() {
        TelegesisGetMainFunctionCommand command = new TelegesisGetMainFunctionCommand();
