...
/**
 * Class to implement the Telegesis command <b>Join Network</b>.
 * <p>
 * Join Network
 * <p>
 ...
 */
public class TelegesisJoinNetworkCommand extends TelegesisFrame implements TelegesisCommand {
    @Override
    public int[] serialize() {
        // Serialize the command fields
        serializeCommand("AT+JN");
    ...
    public String toString() {
        ...
        builder.append("TelegesisJoinNetworkCommand [");
        if (status != null) {
