...
/**
 * Class to implement the Telegesis command <b>Set Input Clusters</b>.
 * <p>
 * Sets the list of input clusters supported by endpoint 2. Up to 12 clusters can be set
 * <p>
...
public class TelegesisSetInputClustersCommand extends TelegesisFrame implements TelegesisCommand {
    ...
    public String toString() {
        ...
        builder.append("TelegesisSetInputClustersCommand [clusterList=");
