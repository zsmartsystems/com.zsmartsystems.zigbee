...
/**
 * Class to implement the Telegesis command <b>Get Network Key</b>.
 * <p>
...
public class TelegesisGetNetworkKeyCommand extends TelegesisFrame implements TelegesisCommand {
    ...
    /**
     *
     * @return the networkKey as {@link ZigBeeKey}
     */
    ...
    public boolean deserialize(int[] data) {
        ...
        // Deserialize field "network key"
        networkKey = deserializeZigBeeKey();
    ...
    public String toString() {
        ...
        builder.append("TelegesisGetNetworkKeyCommand [networkKey=");
