...
/**
 * Class to implement the Telegesis command <b>Create PAN</b>.
 * <p>
 ...
 */
public class TelegesisCreatePanCommand extends TelegesisFrame implements TelegesisCommand {
    @Override
    public int[] serialize() {
        // Serialize the command fields
        serializeCommand("AT+EN");
    ...
    public String toString() {
        ...
        builder.append("TelegesisCreatePanCommand [");
        if (status != null) {
