...
/**
 * Class to implement the Telegesis command <b>Router Announce</b>.
 * <p>
 ...
 */
public class TelegesisRouterAnnounceEvent extends TelegesisFrame implements TelegesisEvent {
    /**
     * FFD response field
     */
    ...
    public void deserialize(int[] data) {
        ...
        // Deserialize the fields for the "FFD" response
        if (testPrompt(data, "FFD:")) {
            setDeserializer(4);
