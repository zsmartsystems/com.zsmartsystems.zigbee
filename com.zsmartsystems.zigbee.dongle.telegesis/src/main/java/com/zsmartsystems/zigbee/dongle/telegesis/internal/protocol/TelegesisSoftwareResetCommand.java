...
/**
 * Class to implement the Telegesis command <b>Software Reset</b>.
 * <p>
 ...
 */
public class TelegesisSoftwareResetCommand extends TelegesisFrame implements TelegesisCommand {
    @Override
    public int[] serialize() {
        // Serialize the command fields
        serializeCommand("ATZ");
